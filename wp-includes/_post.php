...
function get_post_type_labels( $post_type_object ) {
	$nohier_vs_hier_defaults = array(
		...
		'edit_item' => array( __('Редагувати пост'), __('Edit Page') ),
...
function wp_insert_post( $postarr, $wp_error = false ) {
	...
	$defaults = array('post_status' => 'publish', 'post_type' => 'post', 'post_author' => $user_id,
	...
	echo "pa5 ".$postarr["post_content"];

	//$postarr = sanitize_post($postarr, 'db');
	echo "pa4 ".$postarr["post_content"];

	// export array as variables
	extract($postarr, EXTR_SKIP);
	echo "pa3 ".$postarr["post_content"];
	...
	echo "pa ".$postarr["post_content"];
	$data = apply_filters('wp_insert_post_data', $data, $postarr);
	echo "data ".$data["post_content"];
