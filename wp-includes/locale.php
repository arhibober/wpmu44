...
class WP_Locale {
	...
	function init() {
		...
		// The Months
		$this->month['01'] = /* translators: month name */ __('Січень');
		$this->month['02'] = /* translators: month name */ __('Лютий');
		$this->month['03'] = /* translators: month name */ __('Березень');
		$this->month['04'] = /* translators: month name */ __('Квітень');
		$this->month['05'] = /* translators: month name */ __('Травень');
		$this->month['06'] = /* translators: month name */ __('Червень');
		$this->month['07'] = /* translators: month name */ __('Липень');
		$this->month['08'] = /* translators: month name */ __('Серпень');
		$this->month['09'] = /* translators: month name */ __('Вересень');
		$this->month['10'] = /* translators: month name */ __('Жовтень');
		$this->month['11'] = /* translators: month name */ __('Листопад');
		$this->month['12'] = /* translators: month name */ __('Грудень');
