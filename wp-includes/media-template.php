...
function wp_print_media_templates() {
	...
	<script type="text/html" id="tmpl-uploader-inline">
		...
		<?php else : ?>
			<div class="upload-ui">
				<h3 class="upload-instructions drop-instructions"><?php _e( 'Перенесите сюди мишою завнтажувані файли зі свого комп\'ютеру' ); ?></h3>
				<a href="#" class="browser button button-hero"><?php _e( 'Уберіть файли на своєму комп\'ютері' ); ?></a>
			</div>
			...
			<div class="post-upload-ui">
				...
				<p class="max-upload-size"><?php
					printf( __( 'Максимальний можливий розмір завантажуємого файлу: %d%s.' ), esc_html($upload_size_unit), esc_html($byte_sizes[$u]) );
				?></p>
	...
	<script type="text/html" id="tmpl-uploader-status">
		<h3><?php _e( 'Завантаження' ); ?></h3>
		<a class="upload-dismiss-errors" href="#"><?php _e('Обнаружені помілки'); ?></a>
