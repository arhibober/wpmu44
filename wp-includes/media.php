...
function wp_enqueue_media( $args = array() ) {
	...
	$strings = array(
		...
		// Upload
		'uploadFilesTitle'  => __( 'Завантажити файли' ),
		'uploadImagesTitle' => __( 'Завантажити зображення' ),

		// Library
		'mediaLibraryTitle'  => __( 'Раніше завантажені зображення' ),
		'insertMediaTitle'   => __( 'Вставити зображення' ),
		'createNewGallery'   => __( 'Create a new gallery' ),
		'returnToLibrary'    => __( '&#8592; Return to library' ),
		'allMediaItems'      => __( 'Усі типи мультімедійних даних' ),
		'noItemsFound'       => __( 'No items found.' ),
		'insertIntoPost'     => $hier ? __( 'Insert into page' ) : __( 'Вставити в пост' ),
		'uploadedToThisPost' => $hier ? __( 'Uploaded to this page' ) : __( 'Завантажені рані саме для цього посту' ),
		'warnDelete' =>      __( "You are about to permanently delete this item.\n  'Cancel' to stop, 'OK' to delete." ),

		// From URL
		'insertFromUrlTitle' => __( 'Вставити зображення з інтернету' ),

		// Featured Images
		'setFeaturedImageTitle' => __( 'Установити аватар посту' ),
		'setFeaturedImage'    => __( 'Set featured image' ),

		// Gallery
		'createGalleryTitle' => __( 'Создати галерею' ),
