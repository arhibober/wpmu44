...
function media_buttons($editor_id = 'content') {
	...
	echo '<a href="#" id="insert-media-button" class="button insert-media add_media" data-editor="' . esc_attr( $editor_id ) . '" title="' . esc_attr__( 'Додати зображення' ) . '">' . $img . __( 'Додати зображення' ) . '</a>';
...
function get_media_item( $attachment_id, $args = null ) {
	...
	if ( $send )
		$send = get_submit_button( __( 'Вставити в пост' ), 'button', "send[$attachment_id]", false );
...
';
	...
	<table class="describe ' . $table_class . '"><tbody>
		...
		<tr class="image-only">
			<td></td>
			<td>
				<input type="button" class="button" id="go_button" style="color:#bbb;" onclick="addExtImage.insert()" value="' . esc_attr__('Вставити в пост') . '" />
			</td>
		</tr>
		<tr class="not-image">
			<td></td>
			<td>
				' . get_submit_button( __( 'Вставити в пост' ), 'button', 'insertonlybutton', false ) . '
			</td>
		</tr>
	</tbody></table>
';
