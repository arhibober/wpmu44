...
?>
	<h3><?php _e('Настройки щодо e-mail з повідомленнями', MAILUSERS_I18N_DOMAIN); ?></h3>
	...
	<tbody>
		<tr>
			...
			<td>
				...
				<?php _e('Приймати e-mail щодо змін у постах та статичних сторінках', MAILUSERS_I18N_DOMAIN); ?><br/>
				...
				<?php _e('Приймати e-mail не тільки всі свої особисті, але й всі массові', MAILUSERS_I18N_DOMAIN); ?>
			</td>
		</tr>
	</tbody>
	</table>
...
function mailusers_get_users($exclude_id='', $meta_filter = '', $args = array(), $sortby = null, $meta_value = 'true', $meta_compare = '=') {
    ...
    while ($args['offset'] < $total)
    {
		...
		global $wpdb;
			...
			$sqlstr = "SELECT id, user_login, user_email from wp_users";
 ...
 * $meta_filter can be '', MAILUSERS_ACCEPT_NOTIFICATION_USER_META, or MAILUSERS_ACCEPT_MASS_EMAIL_USER_META
 */
function mailusers_get_recipients_from_ids() {
    return mailusers_get_users() ;
}
