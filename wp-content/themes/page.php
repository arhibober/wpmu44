...
<main id='main' class='site-main' role='main'>";
        ...
        while ($file = readdir ($hdl)) 
			...
			{
				echo "<form metchod='post' action='http://localhost/wpmu41/remove_avatar.php'>
				<input type='hidden' name='user' value='".$user_ID."'>
				<input type='hidden' name='user' value='".$_POST ["edit_id"]."'>
				<input type='submit' value='Видалити аватар'>
				</form>";
				$isAvatar = true;
			}
		if (!$isAvatar)
                        ...
                        <li>
                            ...
                            <div class="category-wrap" style="float:left;">
                                <div id="lvl01">
									...
									$cats = array ("Поезія", "Проза", "Живопис і фотографія", "Музика", "Відео", "Щоденник");
                                    ...
                                    /*} else if ( $cat_type == 'ajax' ) {
                                        ...
                                        wpuf_category_checklist ( $_POST ["edit_id"], false, 'category', $exclude);*/
                                    //}
                                    ?>
                                </div>
                            </div>
...
if ($_FILES ["avatar"]["size"] > 1048756)
        ...
        if(is_uploaded_file($_FILES["avatar"]["tmp_name"]))
        {
          ...
          move_uploaded_file($_FILES["avatar"]["tmp_name"],
            "D:/xampp/htdocs/wpmu41/PHOTO".$user_ID."_".$_POST['post_id1'].substr ($_FILES ["avatar"]["name"],
